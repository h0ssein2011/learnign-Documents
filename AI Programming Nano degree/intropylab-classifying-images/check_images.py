...
def main():
    ...
    def classify_images(img_path=in_arg.dir, model=in_arg.arch):
        ...
        for file in filenames:
            ...
            clf_label = clf_label.lower().strip().split(',')
            clf_label_txt = ' '.join([label for label in clf_label])
            ...
            for i in range(len(filenames)):
                ...
                clf_labels[file] = [pet_label, clf_label_txt, compared]
    ...
    def adjust_results4_isadog():
        ...
        for key, val in result_dic.items():
            ...
            if val[0] in dognames_dic:
                pet_label_match = 1

            if val[1] in dognames_dic:
                clf_label_match = 1

            result_dic[key].extend([pet_label_match, clf_label_match])
